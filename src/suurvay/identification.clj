...
(defprotocol TwitterAPI
  (before [this identifier] "Called for any necessary pre-processing. Usually no-op.")
...
(defn twitter-api
  ...
  []
  (reify TwitterAPI
    (get-name [this identifier] (t/get-name identifier))
    (get-profile [this identifier] (t/get-profile identifier))
    (get-timeline-details [this identifier] (t/get-timeline-details identifier))
    (get-friends [this identifier] (t/get-friends identifier))
    (get-followers [this identifier] (t/get-followers identifier))))
